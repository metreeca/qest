...
others on [GitHub Issues](https://github.com/metreeca/qest/issues), telling the world about Metreeca… ;-)

# Reporting Bugs

Before opening an [issue](https://github.com/metreeca/qest/issues) to report a bug, search open issues for similar cases
...
a [discussion](https://github.com/metreeca/qest/discussions) and describe your problem.

# Suggesting Features

If you think you have a good idea about improving or extending this project, feel free to open
an [issues](https://github.com/metreeca/qest/issues), using the dedicated template.
