...
export type StartRuleNames = "Identifier" | "Integer" | "Query" | "PairList" | "Pair" | "LtPair" | "GtPair" | "LtePrefixPair" | "GtePrefixPair" | "LtePostfixPair" | "GtePostfixPair" | "LtPostfixPair" | "GtPostfixPair" | "LikePair" | "DisjunctivePair" | "ConjunctivePair" | "FocusPair" | "SortPair" | "Direction" | "OffsetPair" | "LimitPair" | "Pagination" | "EqualityPair" | "BareExprPair" | "Expr" | "Transform" | "Path" | "Criterion" | "ProjectionCriterion" | "ConstraintCriterion" | "CriterionId" | "CriterionTransform" | "CriterionPath" | "CriterionOp" | "Value";
...
declare function ParseFunction<Options extends ParseOptions<"Identifier">>(
  input: string,
  options?: Options,
): any;
...
declare function ParseFunction<Options extends ParseOptions<"Query">>(
  input: string,
  options?: Options,
): any;

declare function ParseFunction<Options extends ParseOptions<"PairList">>(
  input: string,
  options?: Options,
): any;
...
declare function ParseFunction<Options extends ParseOptions<"LtPair">>(
  input: string,
  options?: Options,
): any;

declare function ParseFunction<Options extends ParseOptions<"GtPair">>(
  input: string,
  options?: Options,
): any;

declare function ParseFunction<Options extends ParseOptions<"LtePrefixPair">>(
  input: string,
  options?: Options,
): any;

declare function ParseFunction<Options extends ParseOptions<"GtePrefixPair">>(
  input: string,
  options?: Options,
): any;
...
declare function ParseFunction<Options extends ParseOptions<"Criterion">>(
  input: string,
  options?: Options,
): any;

declare function ParseFunction<Options extends ParseOptions<"ProjectionCriterion">>(
  input: string,
  options?: Options,
): any;

declare function ParseFunction<Options extends ParseOptions<"ConstraintCriterion">>(
  input: string,
  options?: Options,
): any;

declare function ParseFunction<Options extends ParseOptions<"CriterionId">>(
  input: string,
  options?: Options,
): any;

declare function ParseFunction<Options extends ParseOptions<"CriterionTransform">>(
  input: string,
  options?: Options,
): any;

declare function ParseFunction<Options extends ParseOptions<"CriterionPath">>(
  input: string,
  options?: Options,
): any;

declare function ParseFunction<Options extends ParseOptions<"CriterionOp">>(
  input: string,
  options?: Options,
): any;

declare function ParseFunction<Options extends ParseOptions<"Value">>(
  input: string,
  options?: Options,
): any;
