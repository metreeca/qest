...
import * as peg$import0 from "./1-identifier.js";
...
function peg$parse(input, options) {
    ...
    var peg$e6 = peg$classExpectation(["$", ["A", "["], "_", ["a", "z"]], false, false);
    ...
    var peg$f0 = function (name, pipe, path) {
        return name ? {name, pipe, path} : {pipe, path};
    };
    var peg$f1 = function (id) {
        return id;
    };
    var peg$f2 = function (id) {
        return id;
    };
    var peg$f3 = function (prefix, first, rest) {
    ...
    function peg$parseIdentifier() {
        ...
        s0 = peg$callLibrary(peg$import0, "Identifier");
